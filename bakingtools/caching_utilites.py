...
class CachedProperties():
    ...
    def apply_properties_to_object(self, top_level_object):
        ...
        for property, value in self.properties.items():
            ...
            # If the property_to_update doesn't directly belong to the top_lovel_object, we need to drill down to get a reference to the object_to_update that the property does belong to 
            if "." in property:
